...
CREATE TABLE "LeadsCampaign" (
    "leadsId" INTEGER NOT NULL,
    "campaignId" INTEGER NOT NULL,
    "status" "LeadCampaignStatus" NOT NULL DEFAULT 'New',

    CONSTRAINT "LeadsCampaign_pkey" PRIMARY KEY ("leadsId","campaignId")
);
...
-- AddForeignKey
ALTER TABLE "LeadsCampaign" ADD CONSTRAINT "LeadsCampaign_leadsId_fkey" FOREIGN KEY ("leadsId") REFERENCES "Lead"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
